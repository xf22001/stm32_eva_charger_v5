...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_11
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO_PIN_9, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GPIO_PIN_1|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_7
                          |GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13
                          |GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12
  ...
  /*Configure GPIO pins : PE5 PE6 PE8 PE11
                           PE12 PE13 PE14 PE15 */
  ...
  /*Configure GPIO pins : PH2 PH3 PH6 */
  ...
  /*Configure GPIO pins : PG1 PG3 PG6 PG7
                           PG9 PG11 PG12 PG13
                           PG15 */
  ...
  /*Configure GPIO pins : PD10 PD3 PD4 */
